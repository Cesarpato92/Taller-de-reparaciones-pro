...
export default function RegistroForm({ onRefresh }) {
    ...
    return (
        <form onSubmit={handle} className="bg-white p-6 rounded-2xl shadow-sm border space-y-3">
            ...
            <div className="flex gap-2">
                ...
                <select 
                    className="w-1/2 p-2 bg-slate-50 rounded-lg border text-sm font-medium" 
                    value={f.estado} 
